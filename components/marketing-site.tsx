...
export function MarketingSite() {
  return <div id="postito-landing" className="landing" data-design="motion-5">
    ...
    <main id="conteudo">
      ...
      <section className="landing-platform landing-container" id="plataforma" aria-labelledby="platform-heading"><div className="landing-section-heading"><p className="landing-label">03 / Explore por dentro</p><h2 id="platform-heading" data-motion-heading><MotionCopy text="Toda a operação." /><br /><span><MotionCopy text="Uma visão em comum." /></span></h2><p>Escolha uma área e veja os detalhes da interface.</p></div>
      ...
      <section className="landing-faq landing-container" id="duvidas" aria-labelledby="faq-heading"><div><p className="landing-label">05 / Antes de começar</p><h2 id="faq-heading" data-motion-heading><MotionCopy text="Vamos deixar" /><br /><MotionCopy text="tudo claro." /></h2></div><div className="faq-list">{faqs.map(([question,answer])=><details key={question} data-reveal><summary>{question}<Plus size={20} aria-hidden="true" /></summary><p>{answer}</p></details>)}</div></section>

      <section className="landing-final"><div className="landing-container"><span className="final-orbit" aria-hidden="true"><ArrowUpRight strokeWidth={1} /></span><p className="landing-label">Seu próximo projeto começa aqui</p><h2 data-motion-heading><MotionCopy text="Dê espaço" /><br /><MotionCopy text="às boas ideias." /></h2><Link href="/cadastro" className="landing-button" data-magnetic><span className="button-roll"><span>Criar minha conta</span><span aria-hidden="true">Criar minha conta</span></span> <ArrowUpRight size={20} aria-hidden="true" /></Link><Link href="/login" className="landing-text-link">Já tenho conta <ArrowRight size={18} aria-hidden="true" /></Link></div></section>
    </main>
